...
const headCells = [
  { id: 'symbole', numeric: false, disablePadding: false, label: 'Symbole' },
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{formatter.format(row.size)}</TableCell>
                      <TableCell align="right">{formatter.format(row.open)}</TableCell>
                      <TableCell align="right">{formatter.format(row.amount_open)}</TableCell>
                      <TableCell align="right">{formatter.format(row.close)}</TableCell>
                      <TableCell align="right">{formatter.format(row.amount_close)}</TableCell>
